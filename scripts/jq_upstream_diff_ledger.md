...
- upstream differences old/new: 0 -> 4
- upstream differences new/resolved/changed: 4 / 0 / 0

## New Upstream Differences

- upstream-jq-test-l1188 (`temporary-exception`)
- upstream-jq-test-l1192 (`temporary-exception`)
- upstream-jq-test-l1553 (`temporary-exception`)
- upstream-jq-test-l1557 (`temporary-exception`)
...
- upstream-jq-test-l1188: filter, input, compat_status, compat_ledger_id, compat_reason, compat_removal_condition
- upstream-jq-test-l1192: filter, input, compat_status, compat_ledger_id, compat_reason, compat_removal_condition
